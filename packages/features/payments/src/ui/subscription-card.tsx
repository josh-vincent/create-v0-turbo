...
interface SubscriptionCardProps {
  className?: string;
  api: any; // tRPC client from app
}

/**
 * Display current subscription status with management options
 * @param api - tRPC client from the consuming app (Next.js or Expo)
 */
export function SubscriptionCard({ className, api }: SubscriptionCardProps) {
