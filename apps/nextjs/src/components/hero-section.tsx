            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  <Link
                    href="https://github.com/yourusername/create-v0-turbo"
                    className="hover:bg-background dark:hover:border-t-border bg-muted group mx-auto flex w-fit items-center gap-4 rounded-full border p-1 pl-4 shadow-md shadow-zinc-950/5 transition-colors duration-300 dark:border-t-white/5 dark:shadow-zinc-950"
                  >
                    <span className="text-foreground text-sm">
                      Production-Ready Full-Stack Starter
                    </span>
                ...
                >
                  A modern full-stack Turborepo with Next.js 15, Expo 53, tRPC v11, and Supabase.
                  Modular features, offline-first, and works instantly with zero configuration.
                </TextEffect>
                ...
                >
                  ...
                  >
                    <Link href="https://github.com/yourusername/create-v0-turbo">
          ...
          <div className="group relative m-auto max-w-5xl px-6">
            ...
            <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
              ...
              <div className="flex">
                <img
                  className="mx-auto h-5 w-fit dark:invert"
                  src="https://cdn.simpleicons.org/turborepo"
                  alt="Turborepo Logo"
                  height="20"
                  width="auto"
                />
